    ...
    <footer class="bg-base-10 max-w-screen-xl">
      <div class="mx-auto w-full p-4 py-6 lg:py-8">
            ...
            <div>
              ...
              <ul class="text-gray-500 dark:text-gray-400 font-medium">
                ...
                <li class="mt-2 mb-2">
                  ...
                  <a href="https://x.com/teamsentralia" class="hover:underline">Twitter</a>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
          <span class="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://notreal003.pages.dev" class="hover:underline">NotReal003</a>. All Rights Reserved.
          </span>
          <div class="flex mt-4 sm:justify-center sm:mt-0">
            <a href="https://notreal003.pages.dev/discord" class="text-gray-500 hover:text-gray-900 dark:hover:text-white ms-5">
